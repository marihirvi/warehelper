...
const PageContainer = ({ products, availabilities, loadingProducts, loadingAvailability }) => {
    return (
        <Container>
            <Router>
                <Row>
                ...
                <Switch>
                    ...
                    <Route path="/shirts">
                        <ProductPageContainer category="shirts"
                    ...
                    <Route path="/accessories">
                        <ProductPageContainer category="accessories"
